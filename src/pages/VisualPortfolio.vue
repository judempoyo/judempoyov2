...
<template>
  <div class="visual-portfolio min-h-screen overflow-x-hidden bg-white dark:bg-zinc-900 transition-colors duration-300">
    ...
    <!-- Hero Section -->
    <section id="home" class="min-h-screen flex items-center justify-center pt-20 px-6" ref="hero">
      <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative" ref="heroVisual">
          ...
          <div class="relative bg-white dark:bg-zinc-800 p-2 rounded-3xl shadow-2xl overflow-hidden border-8 border-white dark:border-zinc-800">
            <img src="/judepic.png" alt="Jude Mpoyo" class="rounded-2xl w-full h-auto object-cover aspect-square">
    ...
    <section id="about" class="py-20 px-6 bg-zinc-50 dark:bg-zinc-800/30" ref="about">
      <div class="max-w-7xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold mb-12 text-center dark:text-white" ref="aboutTitle">
          About <span class="text-teal-600 dark:text-teal-400">me</span>
        </h2>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6" ref="aboutText">
            ...
            <!-- Skills Section -->
            <div>
              <h3 class="text-xl font-semibold mb-4 dark:text-white">My Skills</h3>
    ...
    <section id="projects" class="py-20 px-6 bg-white dark:bg-zinc-900" ref="projectsSection">
      <div class="max-w-7xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold mb-12 text-center dark:text-white" ref="projectsTitle">
          My <span class="text-teal-600 dark:text-teal-400">projects</span>
        </h2>

        <transition-group name="fade" tag="div" class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div v-for="(project, index) in projects.slice(0, visibleProjects)"
            :key="project.name"
            class="bg-white dark:bg-zinc-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            ref="projectCards">
            ...
            <div class="p-6">
              ...
              <div class="flex justify-between items-center">
                ...
                <a :href="project.link || '#'" 
                  class="text-teal-600 dark:text-teal-400 hover:text-teal-800 dark:hover:text-teal-300 flex items-center gap-1 text-sm">
                  View more
        ...
        <div class="text-center" v-if="visibleProjects < projects.length">
          <button @click="showMore"
            class="px-6 py-3 bg-teal-600 dark:bg-teal-700 text-white rounded-lg hover:bg-teal-700 dark:hover:bg-teal-600 transition-colors shadow-md flex items-center gap-2 mx-auto">
            Show more projects
    ...
    <!-- Contact Section -->
    <section id="contact" class="py-20 px-6 bg-teal-50 dark:bg-zinc-800/50" ref="contact">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold mb-12 text-center dark:text-white" ref="contactTitle">
          Let's work <span class="text-teal-600 dark:text-teal-400">together</span>
        </h2>
          ...
          <div class="grid md:grid-cols-2">
              ...
              <form class="space-y-6">
                ...
                <div>
                  ...
                  <textarea id="message" rows="4"
                    class="w-full px-4 py-3 rounded-lg border border-zinc-300 dark:border-zinc-700 focus:ring-2 focus:ring-teal-600 focus:border-transparent dark:bg-zinc-900 dark:text-white"></textarea>
                </div>
                <button type="submit" 
            ...
            <div class="bg-teal-600 dark:bg-teal-800 p-8 md:p-12 flex flex-col justify-between">
              ...
              <div class="flex gap-4 mt-8">
                <a v-for="(social, index) in sharedData.socialLinks" :key="index"
                  :href="social.link" 
