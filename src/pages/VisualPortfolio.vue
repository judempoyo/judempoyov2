        ...
        <div class="relative max-w-3xl mx-auto">
          ...
          <div v-for="(exp, index) in sharedData.experience" :key="index" class="mb-12 timeline-item">
            <div class="relative flex items-center justify-between">
              ...
              <!-- Middle dot -->
              <div class="w-8 h-8 rounded-full bg-teal-500 border-4 border-white dark:border-zinc-800 z-10 flex items-center justify-center">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div v-for="(project, index) in projects.slice(0, visibleProjects)" :key="project.name"
            ...
            <div class="p-6">
              <p class="text-zinc-600 dark:text-zinc-400 mb-4 line-clamp-2" itemprop="description">{{ project.description }}
              </p>
              <div class="flex justify-between items-center">
